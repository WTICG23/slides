...
- utilize sempre que possível **boas imagens**;
- inclua preferencialmente apenas **imagens vetoriais** ou de **alta qualidade** (e.g., SVG, PNG, PDF);
- reconstrua as tabelas do texto e apresente tabelas de alta qualidade;
